...
public class DataSyncManager {
    ...
    private static void syncUserData(User userLocal, User userRemote) {
        ...
        if (userRemote.getFollowersCount() != 0) {
            userLocal.setFollowersCount(userRemote.getFollowersCount());
        }
